...
public class Vertex implements Comparable<Vertex> 
{
    ...
    public void setEndDistance (Vertex end)
    {
      if (endDistance == 0)
      {
        endDistance = Main.calculateDistance(latitude, longitude, end.getLatitude(), end.getLongitude());
      }
    }
    ...
    {
      if (this.getDistance() + this.getEndDistance() > vertex.getDistance() + vertex.getEndDistance())
      {
        return 1;
      }
      else if (this.getDistance() + this.getEndDistance() < vertex.getDistance() + vertex.getEndDistance())
      {
        return -1;
      }
      else
