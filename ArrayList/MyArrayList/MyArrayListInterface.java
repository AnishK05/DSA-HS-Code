public interface MyArrayListInterface {
    ...
    */
     ...
     * Shifts any subsequent elements to the left. Returns the 
     * element that was removed from the list. Throws 
     ...
     * this list and returns true if it is present. False is returned 
